...
const User = () => {
  ...
  const occasionImages = [
    "https://imgcdn.floweraura.com/flower_homepage_fa_desktop_18.jpg?tr=w-1583,dpr-1.75,q-70",
    "https://imgcdn.floweraura.com/anniversary_homepage_fa_desktop_3.jpg?tr=w-1583,dpr-1.75,q-70",  
    "https://imgcdn.floweraura.com/valentine_day_landingpage_fa_desktop_2.jpg?tr=w-1583,dpr-1.75,q-70",
    "https://imgcdn.floweraura.com/plant_homepage_fa_desktop_3_0.jpg?tr=w-1583,dpr-1.75,q-70",
    "https://imgcdn.floweraura.com/cake_homepage_fa_desktop_14.jpg?tr=w-1583,dpr-1.75,q-70",  
 ]
  useEffect(() => {
            ...
            <Box sx={{ flexGrow: 0 }}>
              ...
              >
                <MenuItem onClick={handleToggleDetails}>
                  <Typography textAlign="center" onClick={navi} >DASHBOARD</Typography>
                </MenuItem>
              </Menu>
            </Box>
          </Toolbar>
